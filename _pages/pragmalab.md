...
* **Share your data**. You may submit a data sample via [this form](https://docs.google.com/forms/d/1cU7NnjnmKJtNjsOvF2VVJpeYTtGAboj73L0iGELifL4/edit#responses). Submissions can include any type of data, provided they are relevant to the workshop topic and do not exceed 100 items.

* **Lightning talk video**. If you are unable to attend in person, you can still participate by submitting a lightning talk: a one-minute video presenting your take on the workshop topic. Videos can be sent to: socon-nlpsi-workshop-organizers.nlproc@uni-bamberg.de.
